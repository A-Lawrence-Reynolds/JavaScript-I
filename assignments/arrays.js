...
let carModelsSorted = [];
carModelsSorted = inventory.map((car) => car.car_model).sort()
console.log('carModelsSorted', carModelsSorted);
...
console.log("carYearsSorted", carYears);
...
let BMWAndAudi = [];
BMWAndAudi = inventory.filter((fastCar) => fastCar.car_make === 'BMW' || fastCar.car_make === 'Audi')
